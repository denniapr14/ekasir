                ...
                <table style="width: 100%" id="tableSchedule" class="table table-borderless table-responsive-lg">
                    ...
                    <tbody>
                        <?php
                            $no = 1;
                        ?>
                        <?php $__currentLoopData = $getEmployeeScheduleDate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employeeScheduleDate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td style="width: 1rem"><?php echo e($no); ?></td>
                                <td>
                                    <?php echo e(changeDayToIndonesian($employeeScheduleDate->dayNameDS)); ?>,
                                    <?php echo e(tgl_indo($employeeScheduleDate->dateDS)); ?>
                                        ...
                                        <div class="card">
                                            <a class="card-header" id="heading11">
                                                <button class="btn btn-link collapsed" data-toggle="collapse"
                                                    data-target="#collapse<?php echo e($no); ?>" aria-expanded="false"
                                                    aria-controls="collapse1">
                                                    <h5 class="m-b-0">Detail</h5>
                                                </button>
                                            </a>
                                            <div id="collapse<?php echo e($no); ?>" class="collapse"
                                                ...
                                                <div class="card-body">
                                                    <table>
                                                        <?php $__currentLoopData = $getEmployeeSchedule; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employeeSchedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if($employeeSchedule->id_dateSchedule == $employeeScheduleDate->id_dateSchedule): ?>
                                                                <tr>
                                                                    <th>Kasir</th>
                                                                    <th>Pagi</th>
                                                                    <th>Siang</th>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <?php if($userData->levelUser == 'admin'): ?>
                                                                            ...
                                                                            <div class="modal"
                                                                                id="deleteModal<?php echo e($employeeSchedule->id_schedule); ?>"
                                                                        ...
                                                                        <!-- Edit Modal -->
                                                                        <div class="modal"
                                                                            id="editModalSchedule<?php echo e($employeeSchedule->id_schedule); ?>"
                                                                            tabindex="-1" role="dialog"
                                                                            ...
                                                                            <div class="modal-dialog" role="document">
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <form
                                                                                        action="<?php echo e(route('editEmployeeScheduleAction', Crypt::encrypt($employeeSchedule->id_schedule))); ?>"
                                                                                        method="POST"
                                                                                        enctype="multipart/form-data">
                                                                                        <?php echo csrf_field(); ?>
                                                                                        <div class="modal-body">
...
<?php echo $__env->make('Dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Skripsi\ekasir\resources\views/Dashboard/employeScheduleAll.blade.php ENDPATH**/ ?>