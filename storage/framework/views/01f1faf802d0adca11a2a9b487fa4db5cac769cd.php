            ...
            <div>
                ...
                <form action="<?php echo e(route('editProductAction',[Crypt::encrypt($getProduct->id_product)])); ?>" enctype="multipart/form-data" method="post">
                    ...
                    <div id="imagePreviewContainer" class="card">
                        ...
                        <img id="imagePreview" alt="Image Preview" src="<?php echo e(url('Uploads')); ?>/productCompressed/<?php echo e($getProduct->imgProduct); ?>" style="max-width: 100%; max-height: 200px;">
                        <?php else: ?>
...
<?php echo $__env->make('Dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Skripsi\Kasir\resources\views/Dashboard/editProduct.blade.php ENDPATH**/ ?>