                ...
                <div>
                    ...
                    <div class="row container" style="width: 100%">
                        ...
                        <?php $__currentLoopData = $getDateSchedule; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dateSchedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="card <?php echo e($dateSchedule->statusDS == 'work' ? 'border-primary' : 'border-danger'); ?> col-md-2" style="width: 100%;">
...
<?php echo $__env->make('Dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Skripsi\ekasir\resources\views/Dashboard/schedule.blade.php ENDPATH**/ ?>